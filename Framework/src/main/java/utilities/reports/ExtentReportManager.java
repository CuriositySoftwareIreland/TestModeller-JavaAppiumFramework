...
public class ExtentReportManager {
    ...
    public static void failStep(AppiumDriver driver, String stepName)
    {
        reportThreadLocal.get().log(Status.FAIL, stepName);
    }

    public static void passStepWithScreenshot(AppiumDriver driver, String stepName)
    {
        passStepWithScreenshot(driver, stepName, stepName);
    }

    public static void passStepWithScreenshot(AppiumDriver driver, String stepName, String details)
    {
    ...
    public static void failStepWithScreenshot(AppiumDriver driver, String stepName)
    {
        failStepWithScreenshot(driver, stepName, stepName);
    }

    public static void failStepWithScreenshot(AppiumDriver driver, String stepName, String details)
    {
        Media m = ScreenCapture.builder().base64(GetScreenShot.captureAsBase64(driver)).title(stepName).build();
